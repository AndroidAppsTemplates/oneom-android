...
public class EpisodeSearchActivity extends AppCompatActivity {
    ...
    private static final String TAG = EpisodeSearchActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.episode_search_sources_activity);
    ...
    public void configureViews() {
        ...
        toolbar.setTitle(DbUtil.title(episode));
