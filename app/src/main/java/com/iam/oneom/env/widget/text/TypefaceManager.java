...
public class TypefaceManager {
    ...
    private Typeface getTypeface(Context context, TextStyle textStyle) {
        ...
        final Typeface typeface = Typeface.createFromAsset(context.getAssets(), textStyle.getFontAsset());
        if (typeface == null) {
            throw new RuntimeException("Can't create Typeface for font '" + textStyle.getFontAsset() + "'");
        }
